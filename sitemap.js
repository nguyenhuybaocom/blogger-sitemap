         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="Select all posts in the category \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'Article';
   var tocTool1 = 'Sort by title';
   var tocHead2 = 'DATE';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Show all ' + postTitle.length + ' posts<br/><br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Show ' + numDisplayed + ' posts in the category \'';
